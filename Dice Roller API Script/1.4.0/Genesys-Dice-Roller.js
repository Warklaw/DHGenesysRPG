/*
 ...
 Dice Images updated by: Warklaw
...
eote.defaults = {
    ...
    graphics: {
        ...
        ABILITY: {
            BLANK: "http://warklaw.fatcow.com/roll20/genesysRPG/Dice/Ability/ability-6.png",
            A: "http://warklaw.fatcow.com/roll20/genesysRPG/Dice/Ability/ability-3.png",
            AA: "http://warklaw.fatcow.com/roll20/genesysRPG/Dice/Ability/ability-5.png",
            S: "http://warklaw.fatcow.com/roll20/genesysRPG/Dice/Ability/ability-1.png",
            SA: "http://warklaw.fatcow.com/roll20/genesysRPG/Dice/Ability/ability-4.png",
        ...
        for (i = 1; i <= diceQty; i++) {
            ...
            switch (roll) {
                ...
                case 2:
                    ...
                    diceResult.diceGraphicsLog = diceResult.diceGraphicsLog + s1 + eote.defaults.graphics.CHALLENGE.DESPAIR + s2 + "Challenge Despair(+Failure)" + s3 + eote.defaults.globalVars.diceGraphicsChatSize + s4 + eote.defaults.globalVars.diceGraphicsChatSize + s5;
